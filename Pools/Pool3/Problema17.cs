...
/*
        ...
        public static int StringToBase10(string v, int baza)
        {
            int suma = 0;
            int putere = 1;
        ...
        public static float FractionalStringToBase10(string v, int baza)
        {
            int putere = baza, i;
            float suma = 0;
            //Parcurgem sirul
        ...
        public static void Base10ToFinal(int n, int baza)
        {
        ...
        public static void FractionalBase10ToFinal(float n, int baza)
        {
            string HEX = "0123456789ABCDEF";
